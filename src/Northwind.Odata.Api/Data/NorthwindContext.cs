...
namespace Northwind.Odata.Api.Data;
...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<Shared.Models.Customer> Customers { get; set; }
...
//        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=Northwind;Trusted_Connection=True;MultipleActiveResultSets=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AlphabeticalListOfProduct>(entity =>
        {
            ...
            entity.Property(e => e.ProductUniqueId).HasColumnName("ProductUniqueID");
            entity.Property(e => e.ProductUri).HasMaxLength(500);
            entity.Property(e => e.QuantityPerUnit).HasMaxLength(20);
            entity.Property(e => e.ReferenceUniqueId).HasColumnName("ReferenceUniqueID");
        ...
        modelBuilder.Entity<Shared.Models.Customer>(entity =>
        {
            ...
            entity.HasMany(d => d.CustomerTypes).WithMany(p => p.Customers)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    l => l.HasOne<Shared.Models.Customer>().WithMany()
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProductUniqueId, "ProductUniqueID").IsUnique();

            entity.HasIndex(e => e.ReferenceUniqueId, "ReferenceUniqueID");
            ...
            entity.Property(e => e.CategoryId).HasColumnName("CategoryID");
            entity.Property(e => e.ProductName).HasMaxLength(40);
            entity.Property(e => e.ProductUniqueId)
                .HasDefaultValueSql("(newid())")
                .HasColumnName("ProductUniqueID");
            entity.Property(e => e.ProductUri).HasMaxLength(500);
            entity.Property(e => e.QuantityPerUnit).HasMaxLength(20);
            entity.Property(e => e.ReferenceUniqueId)
                .HasDefaultValueSql("(newid())")
                .HasColumnName("ReferenceUniqueID");
